...
def get_conditions(filters, additional_conditions=None):
	...
	if filters.get("branch"):
		conditions += """and ifnull(`tabSales Invoice`.branch, '') = %(branch)s"""

	if filters.get("territory"):
		conditions += """and ifnull(`tabSales Invoice`.territory, '') = %(territory)s"""

	if filters.get("customer_group"):
		conditions += """and ifnull(`tabSales Invoice`.customer_group, '') = %(customer_group)s"""
